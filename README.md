...
This project uses Javadoc standard for commenting and Doxygen to generate documentation.
It is possible to find a pre-compiled version of the documentation in doc/latex/refman.pdf (for the pdf version) or doc/html/index.html (for the website)

```
firefox doc/html/index.html # Website documentation
xdg-open doc/latex/refman.pdf # PDF documentation
```
